...
/*
		...
		//System.exit(0);
		System.out.println("Nova listagem de elementos no dic2");

		// refatprando para usar a classe Pais
		Map<Integer, Pais> dic2 = new HashMap<>();

		// Adiciona algumas entradas...
		Pais p = new Pais(33, "Um local", 300);
		...
		System.out.println("Compara pares com mesmo objeto");
		dic2.put(33, p);
		dic2.put(32, p);
		System.out.println(dic2.get(33));
		System.out.println(dic2.get(32));

		for(Pais pa : dic2.values())
